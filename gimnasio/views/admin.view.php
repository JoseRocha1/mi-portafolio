		...
		<div class="admin"> <!-- Contenedor Administradores -->
			...
			<div class="container-lg"> <!-- Contenedor Tabla Registros -->
				<div class="boton"> <!-- Botón -->
					<a href="new_admin.php" class="btn btn-secondary">Nuevo <i class="fas fa-file"></i></a>
				</div><br> <!-- Botón -->
				<table class="table"> <!-- Tabla -->
					...
					<tbody>
						<?php foreach($registros as $admin): ?>
							<tr>
								<th scope="row"><?php echo $admin['id']; ?></th>
								<td><?php echo $admin['name_admin']; ?></td>
								<td><?php echo $admin['email_admin']; ?></td>
								<td><?php echo fecha($admin['fecha']); ?></td>
								<td><a href="edit_admin.php?id=<?php echo $admin['id']; ?>"><i class="fas fa-pen"></i></a></td>
								<td><a href="delete_admin.php?id=<?php echo $admin['id']; ?>"><i class="fas fa-trash"></i></a></td>
							</tr>
						<?php endforeach; ?>
					</tbody>
				</table> <!-- Tabla -->
