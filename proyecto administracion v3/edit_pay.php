			...
			<div class="container-lg"> <!-- Contenedor Método de Pago -->
				...
				<form method="POST">
					<div class="mb-3">
						...
						<input type="text" name="nombre_comp" class="form-control">
					</div>
					<div class="row g-2">
						<div class="col-md-9">
							<label>Número de tarjeta</label>
							<input type="text" name="num_card" class="form-control" maxlength="20">
						</div>
						<div class="col-md-3">
							<label>CVV</label>
							<input type="text" name="cod_seg" class="form-control" maxlength="4">
						</div>
					</div>
					<div class="row g-2">
						<div class="col-md-6">
							<label>Fecha de expiración</label>
							<select name="fecha_exp" class="form-control">
								<option>Mes</option>
						...
						<div class="col-md-6">
							<label>&nbsp;</label>
							<select name="fecha_year" class="form-control">
								<option>Año</option>
