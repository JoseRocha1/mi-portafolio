...
<body>
	...
	<div class="container"> <!-- Contenedor Principal -->
		<div class="home"> <!-- Contenedor Secundario -->
			<div class="container-md"> <!-- Contenedor Dirección de Envío -->
				...
				<form method="POST">
					...
					<div class="row g-2">
						<div class="col-md">
							...
							<input type="text" name="ad_one" class="form-control">
						</div>
						<div class="col-md">
							<label>Entre calles</label>
							<input type="text" name="ad_two" class="form-control">
						</div>
					</div>
					<div class="row g-3">
						<div class="col-md-4">
					...
					<div class="align_cart">
						...
						<a href="setup_2.php" class="btn btn-info">Continuar</a>
					</div>
				</form>
